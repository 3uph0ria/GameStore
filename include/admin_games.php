										...
										<div class="modal-dialog modal-lg" role="document">
												<div class="modal-content">
														<div class="modal-header">
																<h5 class="modal-title" id="exampleModalLabel<?=$i?>">Добавление новой игры</h5>
														...
														<div class="modal-body">
																<form action="action_add_games.php" method="post">
																		...
																		<div class="md-form mt-4">
																				...
																				<input type="text" id="cost" class="form-control" name="cost" maxlength="11">
																		</div>
																		<div class="md-form mt-4">
																				<label for="amount">Кол-во</label>
																				<input type="text" id="amount" class="form-control" name="amount" maxlength="11">
																		</div>
																		<div class="md-form mt-4">
																		...
																		<div class="md-form mt-4">
																				...
																				<input type="text" id="activation" class="form-control" name="activation" maxlength="50">
																		</div>
																		<div class="md-form mt-4">
																				<label for="platform">Платформа</label>
																				<input type="text" id="platform" class="form-control" name="platform" maxlength="50">
																		</div>
																		<div class="md-form mt-4">
																				<label for="region">Регион</label>
																				<input type="text" id="region" class="form-control" name="region" maxlength="50">
																		</div>
																		<div class="md-form mt-4">
																				<label for="category">Категория</label>
																				<input type="text" id="category" class="form-control" name="category" maxlength="50">
																		</div>
																		<div class="md-form mt-4">
																				<label for="activation_type">Тип товара</label>
																				<input type="text" id="activation_type" class="form-control" name="activation_type" maxlength="50">
																		</div>
																		<div class="md-form mt-4">
